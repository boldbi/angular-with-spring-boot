...
export class DashboardListing implements OnInit {
    ...
    async ngOnInit() {
      ...
      //this.renderDashboard(this._appComponent.embedConfig.dashboardId);
      this.renderDashboard(this._appComponent.embedConfig);
    }
    ...
    renderDashboard(dashboard: Item) {
        ...
        console.log(this._appComponent.baseUrl)
        console.log(this.dashboardService.embedConfig.DashboardId)
        console.log(this.dashboardService.embedConfig.EmbedType)
        console.log(this.dashboardService.embedConfig.Environment)
